...
7. To read the battery level of the server, push the button on the board and release between 2-4 seconds. This app can also enable/disable broadcast of battery level status on the battery server app by pushing and holding the application button for about 8 seconds.
